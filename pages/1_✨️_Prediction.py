...
def predict(result):
    columns_order = [
        ...
        'AUR_SEEDING_2', 'AUR_VOLUMA_2', 'TAR_SEEDING_2', 'JIN_SEEDING_2', 'ZEP_VOLUMA_2', 'JIN_VOLUMA_2', 'VEX_VOLUMA_2', 'NYX_SEEDING_2', 'NYX_VOLUMA_2', 'LEX_VOLUMA_2', 'NICOVITA_2', 'POTENCIAL_GRUPO_2', 'SOW_MAX_ALCANZABLE_2',
        'AUR_SEEDING_3', 'AUR_VOLUMA_3', 'TAR_SEEDING_3', 'JIN_SEEDING_3', 'ZEP_VOLUMA_3', 'JIN_VOLUMA_3', 'VEX_VOLUMA_3', 'NYX_SEEDING_3', 'NYX_VOLUMA_3', 'LEX_VOLUMA_3', 'NICOVITA_3', 'POTENCIAL_GRUPO_3', 'SOW_MAX_ALCANZABLE_3',
        'AUR_SEEDING_4', 'AUR_VOLUMA_4', 'TAR_SEEDING_4', 'JIN_SEEDING_4', 'ZEP_VOLUMA_4', 'JIN_VOLUMA_4', 'VEX_VOLUMA_4', 'NYX_SEEDING_4', 'NYX_VOLUMA_4', 'LEX_VOLUMA_4', 'NICOVITA_4', 'POTENCIAL_GRUPO_4', 'SOW_MAX_ALCANZABLE_4',
        'AUR_SEEDING_5', 'AUR_VOLUMA_5', 'TAR_SEEDING_5', 'JIN_SEEDING_5', 'ZEP_VOLUMA_5', 'JIN_VOLUMA_5', 'VEX_VOLUMA_5', 'NYX_SEEDING_5', 'NYX_VOLUMA_5', 'LEX_VOLUMA_5', 'NICOVITA_5', 'POTENCIAL_GRUPO_5', 'SOW_MAX_ALCANZABLE_5',
        'AUR_SEEDING_6', 'AUR_VOLUMA_6', 'TAR_SEEDING_6', 'JIN_SEEDING_6', 'ZEP_VOLUMA_6', 'JIN_VOLUMA_6', 'VEX_VOLUMA_6', 'NYX_SEEDING_6', 'NYX_VOLUMA_6', 'LEX_VOLUMA_6', 'NICOVITA_6', 'POTENCIAL_GRUPO_6', 'SOW_MAX_ALCANZABLE_6',
        'AUR_SEEDING_7', 'AUR_VOLUMA_7', 'TAR_SEEDING_7', 'JIN_SEEDING_7', 'ZEP_VOLUMA_7', 'JIN_VOLUMA_7', 'VEX_VOLUMA_7', 'NYX_SEEDING_7', 'NYX_VOLUMA_7', 'LEX_VOLUMA_7', 'NICOVITA_7', 'POTENCIAL_GRUPO_7', 'SOW_MAX_ALCANZABLE_7',
        'TOTAL_LB', 'TOTAL_FOB',
        '30-40 (29 g)', '40-50 (23 g)', '50-60 (18 g)', '60-70 (15 g)', '70-80 (13 g)',  '80-100 (11 g)',
        'TOTAL_USD_LECITINA', 'LIBRAS_NETO_LECITINA',
        'TOTAL_USD_SOYA', 'LIBRAS_NETO_SOYA',
        'TOTAL_USD_TRIGO', 'LIBRAS_NETO_TRIGO'
    ]

    columns_out = [
        'AUR_SEEDING_1', 'AUR_VOLUMA_1', 'TAR_SEEDING_1', 'JIN_SEEDING_1', 'ZEP_VOLUMA_1', 'JIN_VOLUMA_1', 'VEX_VOLUMA_1', 'NYX_SEEDING_1', 'NYX_VOLUMA_1', 'LEX_VOLUMA_1',
        'AUR_SEEDING_2', 'AUR_VOLUMA_2', 'TAR_SEEDING_2', 'JIN_SEEDING_2', 'ZEP_VOLUMA_2', 'JIN_VOLUMA_2', 'VEX_VOLUMA_2', 'NYX_SEEDING_2', 'NYX_VOLUMA_2', 'LEX_VOLUMA_2',
        'AUR_SEEDING_3', 'AUR_VOLUMA_3', 'TAR_SEEDING_3', 'JIN_SEEDING_3', 'ZEP_VOLUMA_3', 'JIN_VOLUMA_3', 'VEX_VOLUMA_3', 'NYX_SEEDING_3', 'NYX_VOLUMA_3', 'LEX_VOLUMA_3',
        'AUR_SEEDING_4', 'AUR_VOLUMA_4', 'TAR_SEEDING_4', 'JIN_SEEDING_4', 'ZEP_VOLUMA_4', 'JIN_VOLUMA_4', 'VEX_VOLUMA_4', 'NYX_SEEDING_4', 'NYX_VOLUMA_4', 'LEX_VOLUMA_4',
        'AUR_SEEDING_5', 'AUR_VOLUMA_5', 'TAR_SEEDING_5', 'JIN_SEEDING_5', 'ZEP_VOLUMA_5', 'JIN_VOLUMA_5', 'VEX_VOLUMA_5', 'NYX_SEEDING_5', 'NYX_VOLUMA_5', 'LEX_VOLUMA_5',
        'AUR_SEEDING_6', 'AUR_VOLUMA_6', 'TAR_SEEDING_6', 'JIN_SEEDING_6', 'ZEP_VOLUMA_6', 'JIN_VOLUMA_6', 'VEX_VOLUMA_6', 'NYX_SEEDING_6', 'NYX_VOLUMA_6', 'LEX_VOLUMA_6',
        'AUR_SEEDING_7', 'AUR_VOLUMA_7', 'TAR_SEEDING_7', 'JIN_SEEDING_7', 'ZEP_VOLUMA_7', 'JIN_VOLUMA_7', 'VEX_VOLUMA_7', 'NYX_SEEDING_7', 'NYX_VOLUMA_7', 'LEX_VOLUMA_7'
    ]

    columns_promedio = [
        '30-40 (29 g)', '40-50 (23 g)', '50-60 (18 g)', '60-70 (15 g)', '70-80 (13 g)', '80-100 (11 g)',
        'NICOVITA_1', 'POTENCIAL_GRUPO_1','SOW_MAX_ALCANZABLE_1',
        'NICOVITA_2', 'POTENCIAL_GRUPO_2', 'SOW_MAX_ALCANZABLE_2',
        'NICOVITA_3', 'POTENCIAL_GRUPO_3', 'SOW_MAX_ALCANZABLE_3',
        'NICOVITA_4', 'POTENCIAL_GRUPO_4', 'SOW_MAX_ALCANZABLE_4',
        'NICOVITA_5', 'POTENCIAL_GRUPO_5', 'SOW_MAX_ALCANZABLE_5',
        'NICOVITA_6', 'POTENCIAL_GRUPO_6', 'SOW_MAX_ALCANZABLE_6',
        'NICOVITA_7', 'POTENCIAL_GRUPO_7', 'SOW_MAX_ALCANZABLE_7'
    ]
    agregaciones = {col: 'mean' if col in columns_promedio else 'sum' for col in columns_order}
    ...
    input_data_flatten = pd.concat([input_data.iloc[i] for i in range(input_data.shape[0])], axis=0).to_frame().T
    ...
    output_data_flatten = pd.concat([output_data.iloc[i] for i in range(output_data.shape[0])], axis=0).to_frame().T
    ...
    n_features = int(X_scaled.shape[1] / n_lags)  # Número de características por paso de tiempo.
...
def build_week_dataframes(df):
    ...
    df_pivot = df_melt.pivot_table(index='CLIENTE', columns='PRODUCTO_ETAPA', values='valor', aggfunc='first')
...
def build_week_charts(df, num_week):
    df_pivot = df.melt(id_vars=['CLIENTE'], var_name='PRODUCTO_ETAPA', value_name='VALOR')

    st.altair_chart(alt.Chart(df_pivot).mark_line(point=True).encode(
...
def main():
    ...
    with form:
        date = st.date_input('Fecha', value=None, min_value=min_date, max_value=max_date, key=None, help=None, format='YYYY-MM-DD')
