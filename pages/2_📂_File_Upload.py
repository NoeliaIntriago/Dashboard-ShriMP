...
from queries import upload_exportaciones_data, upload_materia_prima_data, upload_precio_camaron_data, upload_sow_data, upload_ventas_data
...
def main():
    ...
    with form:
        ...
        tabla = col1.selectbox('Seleccione los datos a cargar', ['Exportaciones', 'Materia Prima', 'Precio Camarón', 'Share of Wallet', 'Ventas'])
        archivo = col2.file_uploader('Seleccione el archivo a cargar', type=['xlsx'], accept_multiple_files=False)
